...
// Fondo transparente para que respete el color de la card (dark y high-contrast)
const AGILITY_RPA_ICON =
  `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Crect x='2' y='2' width='44' height='44' rx='8' fill='none' stroke='%2300D4D4' stroke-width='2'/%3E%3Ctext x='24' y='31' font-family='Oswald,sans-serif' font-size='20' font-weight='700' fill='%2300D4D4' text-anchor='middle'%3ERPA%3C/text%3E%3C/svg%3E`
...
export const skills: SkillCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Drupal',       icon: devicon('drupal',    'drupal-plain') },
